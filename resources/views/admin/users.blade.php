...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
    <div class="bg-white border border-[#e8e5e0] px-6 py-5"><p class="text-[11px] font-semibold tracking-[0.12em] uppercase text-gray-500 mb-1">Buyers</p><p class="text-[28px] font-light text-gray-900">{{ $buyers->count() }}</p></div>
...
<div class="bg-white border border-[#e8e5e0] mb-6">
    <div class="px-6 py-4 border-b border-[#e8e5e0]"><h2 class="text-[13px] font-semibold tracking-[0.1em] uppercase text-gray-700">Solo Buyers</h2></div>
    ...
    @empty<tr><td colspan="5" class="px-6 py-10 text-center text-[14px] text-gray-500">No buyers found.</td></tr>@endforelse
    </tbody></table></div>
</div>
